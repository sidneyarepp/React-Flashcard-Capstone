...
function DeckForm({ deckData, setDeckData, handleEditSubmit, handleCreateSubmit }) {
    ...
    return (
        <div>
            <form className="border p-4 rounded" onSubmit={creating ? handleCreateSubmit : handleEditSubmit}>
                ...
                <input type='text' id='name' className="form-control" name='name' value={deckData.name} onChange={handleChange} required />
                <label htmlFor='description' className="form-label mt-2">Description:</label>
                <textarea type='text' id='description' className="form-control" name='description' value={deckData.description} onChange={handleChange} required />
                <div className="mt-3">
